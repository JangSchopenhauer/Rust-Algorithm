...
#Git Access Info
export env_github_id="JangSchopenhauer"
export env_github_Token="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"
#Git remote Address
export env_Project_Name_git="https://github.com/JangSchopenhauer/Rust-Algorithm.git"

#SourceDir
export env_Project_Name_Dir="/home/unet/github/Rust-Algorithm/"
